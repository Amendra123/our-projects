     ...
     console.log(formDirty);
        if (formDirty) {           
            ...
            if(localStorage.getItem("contactData") != undefined){
                ...
                console.log(data);
                const emailExists = data.some(item => item.email === formData.email && item.phoneNumber === formData.phoneNumber);
                if (!emailExists) {
                    data.push(formData);
                    console.log("Entry added successfully");
                    toast.success('Contact Detail saved sussessfully!');
                } else {
                    toast.error('Email already exists, entry not added! AND Phone Number Also');
                    console.log("Email already exists, entry not added");
                }
                    ...
                    <Grid container spacing={2}>
                        ...
                        <Grid container spacing={2} my={5}>
                            ...
                            <Grid item xs={12} sm={6} align="left">
                                <Button variant="contained" style={{ fontSize: "15px" }} onClick={handleSubmit(handleFormSubmit)} color="success"> Submit </Button>
                            </Grid>
                        </Grid>
                    </Grid>
