...
const Showtable = () => {
   ...
   // console.log("kiii")
    useEffect(() => {
        setItinerary("")
        console.log("kiii",)
       let dataN= JSON.parse(localStorage.getItem("contactData"));
       setData(dataN!=""?dataN:[]);
                            ...
                            <Table sx={{ minWidth: 650 }} aria-label="simple table">
                                <TableHead >
                                    ...
                                    <TableCell sx={{ fontWeight: "bold", fontSize: "14px" }}>S. NO.</TableCell>
                                        ...
                                        <TableCell align="right" sx={{ fontWeight: "bold", fontSize: "14px" }}>Email</TableCell>
                                        <TableCell align="right" sx={{ fontWeight: "bold", fontSize: "14px" }}>Phone</TableCell>
                                        <TableCell align="right" sx={{ fontWeight: "bold", fontSize: "14px" }}>Address</TableCell>
                                        
                                        <TableCell align="right" sx={{ fontWeight: "bold", fontSize: "14px" }}>Lat</TableCell>
                                        <TableCell align="right" sx={{ fontWeight: "bold", fontSize: "14px" }}>Lang</TableCell>                                        
                                ...
                                <TableBody>
                                        {data && data?.map((row1, index) => (
                                            ...
                                            >
                                                ...
                                                <TableCell align="right" sx={{ fontSize: '14px' }}>{row1.email}</TableCell>
                                                <TableCell align="right" sx={{ fontSize: '14px' }}>{row1.phoneNumber}</TableCell>
                                                <TableCell align="right" sx={{ fontSize: '14px' }}>{row1.address}</TableCell>
                                                <TableCell align="right" sx={{ fontSize: '14px' }}>{row1.latitude}</TableCell>
                                                <TableCell align="right" sx={{ fontSize: '14px' }}>{row1.longitude}</TableCell>
                                                <TableCell align="right" sx={{ fontSize: '14px' }}><Button variant="contained" type="button" onClick={() => dispatch(row1?.phoneNumber)} color="success" startIcon={<VisibilityIcon/>}> Edit</Button></TableCell>
                                            </TableRow>
                                        ))}
                                    </TableBody>
                            </Table>
